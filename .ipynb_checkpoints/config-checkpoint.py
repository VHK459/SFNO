...
class TrainConfig:
    ...
    # ── Checkpoints ─────────────────────────────────────────────────────────
    phase1_ckpt_name: str = "sfno_phase1SPHERE_layernorm_{step}.pth"
    phase1_final_ckpt: str = "sfno_phase1.pth"
    phase3_load_ckpt: str = "sfno_phase1SPHERE_layernorm_10000.pth"
    phase3_ckpt_name: str = "sfno_phase3_ar_{ar_steps}.pth"
    phase3_final_ckpt: str = "sfno_phase3_final.pth"
    phase4_load_ckpt: str = "sfno_phase1SPHERE_layernorm_10000.pth"
    phase4_ckpt_name: str = "sfno_phase4SPHERE_layernorm_{step}_final.pth"
